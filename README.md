...
[launch Binder](https://mybinder.org/v2/gh/spendierk/UND-TKET-Workshop-2023/main)
 ...
 b) In case you want to run the Jupyter notebooks on your computer, I suggest you install Anaconda: https://www.anaconda.com/products/distribution. Once installed, open and run the "TEST_your_environment.ipynb" Jupyter notebook to make sure you are set for the workshop.
...
`python --version`
I would recommend using either Python 3.9 or Python 3.10. Run the "TEST_your_environment.ipynb" Jupyter notebook to make sure you are set for the workshop.
