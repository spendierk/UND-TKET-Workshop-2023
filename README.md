...
#### a) If you don't want to install anything on your computer just click on "launch Binder" in a new tab to run all the notebooks in a browser: [launch Binder](https://mybinder.org/v2/gh/spendierk/UND-TKET-Workshop-2023/main)
